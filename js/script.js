...
$(document).ready(function() {
    ...
    function SettingsViewModel(globe) {
      var self = this;
      self.settingLayers = ko.observableArray(globe.getLayers('features').reverse());
      ...
      globe.getCategoryTimestamp('features').subscribe(newValue =>
        loadLayers(globe.getLayers('features'), self.settingLayers));
